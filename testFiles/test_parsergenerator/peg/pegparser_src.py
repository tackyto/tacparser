...
class PegParser(Parser):
    ...
    _reg_p_identstart0 = re.compile(u"[a-zA-Z_]", re.M)

    def p_identstart(self):
        # IdentStart <- r"[a-zA-Z_]"
        return self._r(self._reg_p_identstart0)

    _reg_p_identcont0 = re.compile(u"[0-9]", re.M)
    ...
    _reg_p_literal1 = re.compile(u"[']", re.M)

    _reg_p_literal2 = re.compile(u"[']", re.M)

    _reg_p_literal3 = re.compile(u'["]', re.M)

    _reg_p_literal4 = re.compile(u'["]', re.M)

    _reg_p_literal5 = re.compile(u'["]', re.M)
    ...
    _reg_p_char0 = re.compile(u"[nrt'\\\"\\[\\]\\\\]", re.M)

    _reg_p_char1 = re.compile(u"[0-2][0-7][0-7]", re.M)

    _reg_p_char2 = re.compile(u"[0-7][0-7]?", re.M)

    _reg_p_char3 = re.compile(u".", re.M)
    ...
    _reg_p_endoffile0 = re.compile(u".", re.M)
