...
class ExPegParser(Parser):
    ...
    def __init__(self):
        ...
        self.def_dict = {"ExPeg": self.p_expeg,
                         ...
                         "Term": self.p_term,
                         "Assignment": self.p_assignment,
                         "AssignmentVariable": self.p_assignmentvariable,
    ...
    def p_multisequence(self):
        ...
        return self._seq(self._p(self.p_term, "Term"),
                         self._rpt(self._p(self.p_term, "Term"), 1)
                         )

    def p_singlesequence(self):
        # SingleSequence <- Term
        return self._p(self.p_term, "Term")
    ...
    def p_term(self):
        ...
        return self._sel(self._p(self.p_assignment, "Assignment"),
                         self._p(self.p_prefix, "Prefix")
                         )

    def p_assignment(self):
        # Assignment <- Prefix EQUAL AssignmentVariable
        return self._seq(self._p(self.p_prefix, "Prefix"),
                         self._p(self.p_equal, "EQUAL"),
                         self._p(self.p_assignmentvariable, "AssignmentVariable")
                         )

    def p_assignmentvariable(self):
    ...
    _reg_p_regularexpoptions0 = re.compile(u"(m|X|A|I|S)+", re.M)
    ...
    _reg_p_identifier0 = re.compile(u"[a-zA-Z][a-zA-Z0-9_]*", re.M)
    ...
    _reg_p_macroidentifier0 = re.compile(u"_[A-Z][A-Z0-9_]*", re.M)
    ...
    _reg_p_parametername0 = re.compile(u"[a-zA-Z][a-zA-Z0-9_]*", re.M)
    ...
    _reg_p_singlequotesliteralcontents0 = re.compile(u"(\\\\.|[^'\\\\])*", re.M)
    ...
    _reg_p_doublequotesliteralcontents0 = re.compile(u'(\\\\.|[^"\\\\])*', re.M)
    ...
    _reg_p_number0 = re.compile(u"[1-9][0-9]*", re.M)
    ...
    _reg_p_endofline0 = re.compile(u"\\r\\n|\\n|\\r", re.M)
